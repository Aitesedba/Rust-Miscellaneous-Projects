...
// This file exists here as functions to draw shapes, It'll get removed when Bevy updates
// to version 0.8, and drawing more complex shapes just becomes a regular feature
